...
def knn_classify(X_tr, y_tr, X_test, y_test, description, _C=1.0):
...
print("\nknn:\n")
model_bow = knn_classify(X_tr_bow, y_tr, X_te_bow, y_te, 'bow')
model_tfidf = knn_classify(X_tr_tfidf, y_tr, X_te_tfidf, y_te, 'tf-idf')
